...
class SalesforceBulkAPI(object):
    ...
    def __init__(self, username=None, password=None, security_token=None, organization_id=None, sandbox=False, API_version="41.0", batch_size=5000, logger=None, verbose=True):
    ...
    def get_result_id_or_list(self, job_id):
        batch_id = self.batches[job_id][0]
        self.wait_for_batch(batch_id)
